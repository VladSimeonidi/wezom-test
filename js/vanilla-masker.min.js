...
!function (a, b) {
  ...
  var a = [9, 16, 17, 18, 36, 37, 38, 39, 40, 91, 92, 93],
    ...
    for (var c = 0, d = a.length; c < d; c++) {
      ...
      c = function c(a) {
    return a = a || {}, a = { delimiter: a.delimiter || ".", lastOutput: a.lastOutput, precision: a.hasOwnProperty("precision") ? a.precision : 2, separator: a.separator || ",", showSignal: a.showSignal, suffixUnit: a.suffixUnit && " " + a.suffixUnit.replace(/[\s]/g, "") || "", unit: a.unit && a.unit.replace(/[\s]/g, "") + " " || "", zeroCents: a.zeroCents }, a.moneyPrecision = a.zeroCents ? 0 : a.precision, a;
  },
      d = function d(a, b, c) {
    for (; b < a.length; b++) {
    ...
    for (var c = this, d = function d(_d) {
      _d = _d || window.event;var e = _d.target || _d.srcElement;b(_d.keyCode) && setTimeout(function () {
    ...
    if (!a) throw new Error("VanillaMasker: There is no element to bind.");var b = "length" in a ? a.length ? a : [] : [a];return new e(b);
  };return f.toMoney = function (a, b) {
    if (b = c(b), b.zeroCents) {
      b.lastOutput = b.lastOutput || "";var d = "(" + b.separator + "[0]{0," + b.precision + "})",
          e = new RegExp(d, "g"),
          f = a.toString().replace(/[\D]/g, "").length || 0,
          g = b.lastOutput.toString().replace(/[\D]/g, "").length || 0;a = a.toString().replace(e, ""), f < g && (a = a.slice(0, a.length - 1));
        ...
        m = new Array(b.precision + 1).join("0");k = k.substr(k.length % 3, k.length);for (var n = 0, o = k.length; n < o; n++) {
      n % 3 == 0 && (l += b.delimiter), l += k[n];
    }l = l.replace(i, ""), l = l.length ? l : "0";var p = "";if (!0 === b.showSignal && (p = a < 0 || a.startsWith && a.startsWith("-") ? "-" : ""), !b.zeroCents) {
      var q = h.length - b.precision,
          r = h.substr(q, b.precision),
          s = r.length;m = (m + r).slice(-(b.precision > s ? b.precision : s));
    }return (b.unit + p + l + b.separator + m).replace(j, "") + b.suffixUnit;
  }, f.toPattern = function (a, b) {
    var c,
        e = "object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) ? b.pattern : b,
        f = e.replace(/\W/g, ""),
        g = e.split(""),
        ...
        j = 0,
        k = g.length,
        l = "object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) ? b.placeholder : void 0;for (c = 0; c < k; c++) {
      if (j >= h.length) {
        if (f.length == i.length) return g.join("");if (void 0 !== l && f.length > i.length) return d(g, c, l).join("");break;
